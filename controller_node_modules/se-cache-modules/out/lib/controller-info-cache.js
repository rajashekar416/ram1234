(function() {
  var ControllerInfoCache, EventEmitter, async, logger, netUtils, util,
  ...
  ControllerInfoCache = (function() {
    function ControllerInfoCache(redisClientManager1, cloudServerHost, cloudServerPort) {
      this.redisClientManager = redisClientManager1;
      this.cloudServerHost = cloudServerHost;
      this.cloudServerPort = cloudServerPort;
      this.getBySocketId = bind(this.getBySocketId, this);
      this.getByName = bind(this.getByName, this);
      this.clearSocketIdHash = bind(this.clearSocketIdHash, this);
      this.removeBySocketId = bind(this.removeBySocketId, this);
      this.removeByName = bind(this.removeByName, this);
      this.add = bind(this.add, this);
      this.removeController = bind(this.removeController, this);
      this.keyPatterns = {
