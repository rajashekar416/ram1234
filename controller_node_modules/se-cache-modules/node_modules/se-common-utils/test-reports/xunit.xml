<testsuite name="Mocha Tests" tests="48" failures="0" errors="0" skipped="0" timestamp="Fri, 26 Jun 2015 16:29:13 GMT" time="0.045">
<testcase classname="The config file loader" name="should load a well formed config file correctly" time="0.003"/>
<testcase classname="The config file loader" name="should override default values with values from the config file" time="0.001"/>
...
<testcase classname="The config file loader" name="should return an empty config object when loading a non-existent file and passing null as default config" time="0"/>
<testcase classname="The config file loader" name="should throw an exception when loading a non well formatted existing file and passing null as default config" time="0.001"/>
<testcase classname="The config file loader" name="should load the development config file for the dev environment if no parameters are specified" time="0.004"/>
...
<testcase classname="The config file loader" name="should load the development config file if no environment is specified if no parameters are specified" time="0"/>
...
<testcase classname="The config file loader" name="should load the test config file for the test environment if no parameters are specified" time="0"/>
...
<testcase classname="The config file loader" name="should load the default config file for the staging environment if no target config file can be  found and if no parameters are specified" time="0.001"/>
...
<testcase classname="The config file loader" name="should write a config file to disk" time="0.002"/>
<testcase classname="The db-utils," name="should send default message if validation error is null" time="0"/>
<testcase classname="The db-utils," name="should send default message if validation path is unknown" time="0.001"/>
<testcase classname="The db-utils," name="should be able to determine if an object is a valid mongoDB objectId" time="0"/>
<testcase classname="The db-utils," name="should send default message if validation type is unknown" time="0.001"/>
...
<testcase classname="httputils' prefixAbsoluteHrefsWith" name="should prefix one instance of absolute href containing only a path of '/'" time="0"/>
...
<testcase classname="httputils' replaceHostAndPortInHrefs" name="should support replacing an absolute href with host and no port with the same href with a different host" time="0.001"/>
...
<testcase classname="httputils' replaceHostAndPortInHrefs" name="should support replacing an absolute href with a specific protocol, specific host and port with an HTTPS href with the  supplied host and port" time="0.001"/>
...
<testcase classname="httputils' replaceHostAndPortInHrefs" name="should support specifying the same protocol as the original href" time="0.001"/>
