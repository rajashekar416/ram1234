<testsuite name="Mocha Tests" tests="48" failures="0" errors="0" skipped="0" timestamp="Mon, 02 Feb 2015 22:38:43 GMT" time="0.033">
...
<testcase classname="The config file loader" name="should load the development config file for the dev environment if no parameters are specified" time="0"/>
<testcase classname="The config file loader" name="should load the default config file for the dev environment if no target config file can be found and  if no parameters are specified" time="0"/>
...
<testcase classname="The config file loader" name="should load the default config file for the test environment if no target config file can be found and if no  parameters are specified" time="0"/>
<testcase classname="The config file loader" name="should load the staging config file for the staging environment if no parameters are specified" time="0"/>
...
<testcase classname="The config file loader" name="should load the default config file for the production environment if no parameters are specified and if " time="0"/>
...
<testcase classname="The db-utils," name="should send default message if error message is null" time="0.001"/>
...
<testcase classname="httputils' prefixAbsoluteHrefsWith" name="should prefix one instance of absolute href containing only a path" time="0.001"/>
