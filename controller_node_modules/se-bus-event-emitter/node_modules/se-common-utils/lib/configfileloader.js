(function() {
  var fs, getFilePath, loadConfigFile, saveConfigToFile, stripComments, tmpfs, util;
  ...
  */
  ...
  loadConfigFile = function(filePath, defaultConfig) {
    var config, defaultConfigKey, defaultConfigValue, error, fileConfig, fileConfigKey, fileConfigValue, fileContent, logMsg, logObj;
    config = {};
    ...
    try {
      ...
      error = _error;
      fileContent = null;
      logMsg = 'Could not read config file, returning empty config object.';
      logObj = {
        file_path: filePath,
        err: error
      };
