...
var msgpack5Transformers = require('msgpack5-transformers');
var msgpack              = require('msgpack5')();
// end node

msgpack5Transformers.dateTransformer.register(msgpack);
...
BinaryStream.prototype._write = function(code, data, bonus) {
  ...
  if (this._socket != null && this._socket._socket != null && this._socket._socket['version-lib'] === '1.2.2') {
    message = msgpack.encode([code, data, bonus]);
  }
  else {
    message = util.pack([code, data, bonus]);
  }
